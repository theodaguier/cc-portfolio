...
var require_virtualscroll = __commonJS({
  "node_modules/virtual-scroll/lib/virtualscroll.js"(exports, module) {
    !function(e2, t2) {
      ...
      var o2 = n2;
      o2.TinyEmitter = n2;
      var s2, h = "virtualscroll", r2 = t2("options"), a2 = t2("el"), l2 = t2("emitter"), u = t2("event"), c2 = t2("touchStart"), d = t2("bodyTouchAction");
      return function() {
        function e3(e4) {
          var t4 = this;
          Object.defineProperty(this, r2, { writable: true, value: void 0 }), Object.defineProperty(this, a2, { writable: true, value: void 0 }), Object.defineProperty(this, l2, { writable: true, value: void 0 }), Object.defineProperty(this, u, { writable: true, value: void 0 }), Object.defineProperty(this, c2, { writable: true, value: void 0 }), Object.defineProperty(this, d, { writable: true, value: void 0 }), this._onWheel = function(e5) {
            ...
            i2(t4, c2)[c2].x = n3.pageX, i2(t4, c2)[c2].y = n3.pageY;
            ...
            o3.deltaX = (s3.pageX - i2(t4, c2)[c2].x) * n3.touchMultiplier, o3.deltaY = (s3.pageY - i2(t4, c2)[c2].y) * n3.touchMultiplier, i2(t4, c2)[c2].x = s3.pageX, i2(t4, c2)[c2].y = s3.pageY, t4._notify(e5);
...
function o(t2, e2, o2) {
  return e2 && i(t2.prototype, e2), o2 && i(t2, o2), Object.defineProperty(t2, "prototype", { writable: false }), t2;
}
function r() {
...
var a = function() {
  ...
  var e2 = t2.prototype;
  return e2.to = function(t3, e3) {
    var i2 = this, o2 = void 0 === e3 ? {} : e3, n2 = o2.duration, s2 = void 0 === n2 ? 1 : n2, a2 = o2.easing, c2 = void 0 === a2 ? function(t4) {
      return t4;
    } : a2, h = function(t4, e4) {
      if (null == t4)
        return {};
      var i3, o3, r2 = {}, n3 = Object.keys(t4);
      for (o3 = 0; o3 < n3.length; o3++)
        e4.indexOf(i3 = n3[o3]) >= 0 || (r2[i3] = t4[i3]);
      return r2;
    }(o2, l);
    this.target = t3, this.fromKeys = r({}, h), this.toKeys = r({}, h), this.keys = Object.keys(r({}, h)), this.keys.forEach(function(e4) {
      i2.fromKeys[e4] = t3[e4];
    }), this.duration = s2, this.easing = c2, this.currentTime = 0, this.isRunning = true;
  }, e2.stop = function() {
    ...
    if (this.isRunning) {
      ...
      this.keys.forEach(function(t4) {
        var o2 = e3.fromKeys[t4];
        e3.target[t4] = o2 + (e3.toKeys[t4] - o2) * i2;
      }), 1 === i2 && this.stop();
    }
  }, o(t2, [{ key: "progress", get: function() {
...
var c = function(t2) {
  var i2, r2;
  function l2(i3) {
    var o2, r3, n2, s2, l3 = void 0 === i3 ? {} : i3, c3 = l3.duration, h = void 0 === c3 ? 1.2 : c3, p = l3.easing, u = void 0 === p ? function(t3) {
      return Math.min(1, 1.001 - Math.pow(2, -10 * t3));
    } : p, d = l3.smooth, f = void 0 === d || d, v = l3.mouseMultiplier, w = void 0 === v ? 1 : v, g = l3.smoothTouch, m = void 0 !== g && g, y = l3.touchMultiplier, b = void 0 === y ? 2 : y, S = l3.direction, N = void 0 === S ? "vertical" : S, O = l3.gestureDirection, z = void 0 === O ? "vertical" : O, R = l3.infinite, W = void 0 !== R && R, M = l3.wrapper, T = void 0 === M ? window : M, k = l3.content, j = void 0 === k ? document.body : k;
    (s2 = t2.call(this) || this).onWindowResize = function() {
      ...
      var e2 = t3[0];
      if (e2) {
        var i4 = e2.contentRect;
        s2.wrapperWidth = i4.width, s2.wrapperHeight = i4.height;
      }
    }, s2.onContentResize = function(t3) {
      var e2 = t3[0];
      if (e2) {
        var i4 = e2.contentRect;
        s2.contentWidth = i4.width, s2.contentHeight = i4.height;
      }
    }, s2.onVirtualScroll = function(t3) {
      var e2 = t3.deltaY, i4 = t3.deltaX, o3 = t3.originalEvent;
      if (!("vertical" === s2.gestureDirection && 0 === e2 || "horizontal" === s2.gestureDirection && 0 === i4)) {
        var r4 = !!o3.composedPath().find(function(t4) {
          return t4.hasAttribute && t4.hasAttribute("data-lenis-prevent");
        });
        o3.ctrlKey || r4 || (s2.smooth = o3.changedTouches ? s2.smoothTouch : s2.options.smooth, s2.stopped ? o3.preventDefault() : s2.smooth && 4 !== o3.buttons && (s2.smooth && o3.preventDefault(), s2.targetScroll -= "both" === s2.gestureDirection ? i4 + e2 : "horizontal" === s2.gestureDirection ? i4 : e2, s2.scrollTo(s2.targetScroll)));
      }
    ...
    }, window.lenisVersion = "0.2.28", s2.options = { duration: h, easing: u, smooth: f, mouseMultiplier: w, smoothTouch: m, touchMultiplier: b, direction: N, gestureDirection: z, infinite: W, wrapper: T, content: j }, s2.duration = h, s2.easing = u, s2.smooth = f, s2.mouseMultiplier = w, s2.smoothTouch = m, s2.touchMultiplier = b, s2.direction = N, s2.gestureDirection = z, s2.infinite = W, s2.wrapperNode = T, s2.contentNode = j, s2.wrapperNode.addEventListener("scroll", s2.onScroll), s2.wrapperNode === window ? (s2.wrapperNode.addEventListener("resize", s2.onWindowResize), s2.onWindowResize()) : (s2.wrapperHeight = s2.wrapperNode.offsetHeight, s2.wrapperWidth = s2.wrapperNode.offsetWidth, s2.wrapperObserver = new ResizeObserver(s2.onWrapperResize), s2.wrapperObserver.observe(s2.wrapperNode)), s2.contentHeight = s2.contentNode.offsetHeight, s2.contentWidth = s2.contentNode.offsetWidth, s2.contentObserver = new ResizeObserver(s2.onContentResize), s2.contentObserver.observe(s2.contentNode), s2.targetScroll = s2.scroll = s2.lastScroll = s2.wrapperNode[s2.scrollProperty], s2.animate = new a();
    var D = (null == (o2 = navigator) || null == (r3 = o2.userAgentData) ? void 0 : r3.platform) || (null == (n2 = navigator) ? void 0 : n2.platform) || "unknown";
    return s2.virtualScroll = new import_virtual_scroll.default({ el: s2.wrapperNode, firefoxMultiplier: 50, mouseMultiplier: s2.mouseMultiplier * (D.includes("Win") || D.includes("Linux") ? 0.84 : 0.4), touchMultiplier: s2.touchMultiplier, passive: false, useKeyboard: false, useTouch: true }), s2.virtualScroll.on(s2.onVirtualScroll), s2;
  }
  r2 = t2, (i2 = l2).prototype = Object.create(r2.prototype), i2.prototype.constructor = i2, n(i2, r2);
  var c2 = l2.prototype;
  ...
  }, c2.setScroll = function(t3) {
    var e2 = this.infinite ? s(t3, this.limit) : t3;
    "horizontal" === this.direction ? this.wrapperNode.scrollTo(e2, 0) : this.wrapperNode.scrollTo(0, e2);
  }, c2.notify = function() {
    var t3 = this.infinite ? s(this.scroll, this.limit) : this.scroll;
  ...
  }, c2.scrollTo = function(t3, e2) {
    var i3 = void 0 === e2 ? {} : e2, o2 = i3.offset, r3 = void 0 === o2 ? 0 : o2, n2 = i3.immediate, s2 = void 0 !== n2 && n2, l3 = i3.duration, a2 = void 0 === l3 ? this.duration : l3, c3 = i3.easing, h = void 0 === c3 ? this.easing : c3;
    if (null != t3 && !this.stopped) {
      var p;
      if ("number" == typeof t3)
        p = t3;
      else if ("top" === t3 || "#top" === t3)
        p = 0;
      else if ("bottom" === t3)
        p = this.limit;
      else {
        var u;
        if ("string" == typeof t3)
          u = document.querySelector(t3);
        else {
          if (null == t3 || !t3.nodeType)
            return;
          u = t3;
        }
        if (!u)
      ...
      p += r3, this.targetScroll = this.infinite ? p : Math.max(0, Math.min(p, this.limit)), !this.smooth || s2 ? (this.animate.stop(), this.scroll = this.lastScroll = this.targetScroll, this.setScroll(this.targetScroll)) : this.animate.to(this, { duration: a2, easing: h, scroll: this.targetScroll });
    }
  }, o(l2, [{ key: "scrollProperty", get: function() {
...
}(import_tiny_emitter.TinyEmitter);
export {
  c as default
};
