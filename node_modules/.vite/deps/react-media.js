...
var Media = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return render2 ? isAnyMatches ? render2(matches) : null : children ? typeof children === "function" ? children(matches) : !Array.isArray(children) || children.length ? isAnyMatches ? import_react.default.Children.only(children) && typeof import_react.default.Children.only(children).type === "string" ? import_react.default.Children.only(children) : import_react.default.cloneElement(import_react.default.Children.only(children), {
      matches
    }) : null : null : null;
  };
  return Media2;
